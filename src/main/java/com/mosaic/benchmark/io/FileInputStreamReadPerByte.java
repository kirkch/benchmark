 ...
 *
 */
public class FileInputStreamReadPerByte extends Benchmark {

    private int fileSizeBytes;
    private File             file;
    private RandomAccessFile raFile;

    public FileInputStreamReadPerByte() {
        super(
            "bytes", // units
            BenchmarkSizing.LocalDisk,
            "How fast is reading from InputFileStream one byte at a time?", // question
