 ...
 *
 */
public class DirectByteBufferWrite extends Benchmark {

    private int bufferSize;
    private ByteBuffer buf;

    public DirectByteBufferWrite() {
        super(
            "direct buffer writes", // units
            BenchmarkSizing.InMemory,
            "How fast is writing to a direct nio byte buffer?", // question
